...
public class GeneralisationRightPanelAgentComplement implements AgentObserver {
    ...
    public void add(JPanel rightPanel) {
         ...
         * 
         * donneesGraphique=new XYSeries("1"); indexGraphique=0;
         * XYSeriesCollection col=new XYSeriesCollection(); //IntervalXYDataset
         * dataset=new XYBarDataset(col, 1.0); col.addSeries(donneesGraphique);
         * //for (int i=0;i<5000;i++) donneesGraphique.add(i, 5.0+i*i);
         * 
