...
public class ScaleMasterElement {
    ...
    /**
     * The ordered list of generalisation processes to apply on selected
     * features for {@code this} scale master unit.
     */
    ...
    public int hashCode() {
        ...
        result = prime * result + ((processesToApply == null) ? 0
                : processesToApply.hashCode());
        result = prime * result
                + ((scaleLine == null) ? 0 : scaleLine.hashCode());
        return result;
    }
    ...
    /**
     * For display of the element in a GUI.
     * 
     * @return
     */
