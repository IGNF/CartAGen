...
public class GeneralisationConfigurationFrame extends JFrame {
    ...
    public JTextField tDescription = new JTextField("" + GeneralisationSpecifications.getDESCRIPTION());
    public JLabel lEchelleCible = new JLabel("Map scale   1:");
    public JTextField tEchelleCible = new JTextField("" + Legend.getSYMBOLISATI0N_SCALE());
    public JLabel lResolution = new JLabel("Resolution");
    public JTextField tResolution = new JTextField("" + GeneralisationSpecifications.getRESOLUTION());
    ...
    private GeneralisationConfigurationFrame() {
        ...
        panneauOnglets.addTab("General", new ImageIcon(
                GeneralisationConfigurationFrame.class.getResource("/images/co.gif").getPath().replaceAll("%20", " ")),
    ...
    public void validateValues() {
        ...
        GeneralisationSpecifications.setRESOLUTION(Double.parseDouble(tResolution.getText()));

        StyledLayerDescriptor sld = null;
        if (CartAGenDoc.getInstance() != null && CartAGenDoc.getInstance().getCurrentDataset() != null)
            sld = CartAGenDoc.getInstance().getCurrentDataset().getSld();
        else
            sld = CartAGenPlugin.getInstance().getApplication().getMainFrame().getSelectedProjectFrame().getSld();

        SLDUtilCartagen.changeSymbolisationScale(Double.parseDouble(tEchelleCible.getText()), sld);
    ...
    class SaveAction extends AbstractAction {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            parcourir.setSelectedFile(new File(CartAGenPlugin.getInstance().getCheminFichierConfigurationGene()));
