 ...
 * 
 */
public class HydroSurfaceElevationRelation extends ObjectFieldRelation {
  /**
     */
  private double valeurCourante;

  public HydroSurfaceElevationRelation(ReliefFieldAgent ac, SectionAgent tr) {
    super(ac, tr);
  }

  public HydroSurfaceElevationRelation(SectionAgent tr) {
    super(
