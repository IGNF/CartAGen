...
public class GeneralisationMenuAgentComplement {
  static Logger logger = Logger
      .getLogger(GeneralisationMenuAgentComplement.class.getName());
  ...
  private JMenuItem mCreateAGENTAgents = new JMenuItem(
      new CreateAGENTAgentsAction());

  // CartACom
  private JMenu menuCartACom = new JMenu("CartACom");
  private JMenuItem mCreateCartAComAgents = new JMenuItem(
      new CreateCartAComAgentsAction());

  // GAEL
  private JMenu menuGAEL = new JMenu("GAEL");
  private JMenuItem mCreateGAELAgents = new JMenuItem(
      new CreateGAELAgentsAction());
  ...
  public JCheckBoxMenuItem mAgentsPointVoirId = new JCheckBoxMenuItem(
      "Display id");
  public JCheckBoxMenuItem mAgentsPointVoirIni = new JCheckBoxMenuItem(
      "Display initial");
  public JCheckBoxMenuItem mAgentsPointVoirLien = new JCheckBoxMenuItem(
      "Display link to initial");
  public JCheckBoxMenuItem mAgentsPointVoirTexteLien = new JCheckBoxMenuItem(
      "Display text on link");
  public JCheckBoxMenuItem mAgentsPointVoirTexteDesequilibre = new JCheckBoxMenuItem(
      "Display unbalance value");
  public JCheckBoxMenuItem mAgentsPointVoirVecteursDeplacement = new JCheckBoxMenuItem(
      "Display vectors");
  public JCheckBoxMenuItem mAgentsPointEnregistrerTrajectoire = new JCheckBoxMenuItem(
      "Store routes");
  private JMenuItem mAgentsPointEffacerTrajectoire = new JMenuItem(
      "Delete routes");
  public JCheckBoxMenuItem mAgentsPointVoirTrajectoire = new JCheckBoxMenuItem(
      "Display routes");
  ...
  private JMenuItem mBuildingsSatisfactionDitribution = new JMenuItem(
      "Buildings satisfaction distribution");
  private JMenuItem mBlocksSatisfactionDitribution = new JMenuItem(
      "Blocks satisfaction distribution");

  // Gestion connaissances
  private JMenu menuGestionK = new JMenu("Knowledge Revision");
  private JMenuItem mChargeFichierK = new JMenuItem(
      "Chargement fichier connaissances");
  private JMenuItem mSauvegardeFichierK = new JMenuItem(
      "Sauvegarde fichier connaissances");
  private JMenuItem mChargeEchantillonRev = new JMenuItem(
      "Chargement échantillon révision");
  private JMenuItem mRevisionKBat = new JMenuItem(
      "Révision des connaissances des bâtiments");
  private JMenuItem mRevisionKIlot = new JMenuItem(
      "Révision des connaissances des îlots");
  private JMenuItem mDefinitionK = new JMenuItem(
      "Définition des connaissances");
  private JMenuItem mAcquiKExpert = new JMenuItem(
      "Acquisition des connaissances des experts");
  private JMenuItem mDefBesoinUtilisateur = new JMenuItem(
      "Définition des besoins utilisateurs");
  private JMenuItem mTestCritereVal = new JMenuItem(
      "Test des critères de validité");
  ...
  public JMenu getMenuComplement(Class<? extends JMenu> menuClass) {
    MainFrameMenuBar menu = CartAGenPlugin.getInstance().getApplication()
        .getMainFrame().getMenuBar();
  ...
  public void add(JMenuBar menu) {
    ...
    this.mBuildingsSatisfactionDitribution
        .addActionListener(new ActionListener() {
          ...
          public void actionPerformed(ActionEvent e) {
            ...
            for (IBuilding obj : CartAGenDoc.getInstance().getCurrentDataset()
                .getBuildings()) {
              BuildingAgent ag = (BuildingAgent) AgentUtil
                  .getAgentFromGeneObj(obj);
              ag.computeSatisfaction();
              data.add(new Double(ag.getSatisfaction()));
            }
            (new FrameDistribution("Buildings satisfaction", data, 100, true))
                .setVisible(true);
          }
        });
    ...
    this.mBlocksSatisfactionDitribution.addActionListener(new ActionListener() {
      ...
      public void actionPerformed(ActionEvent e) {
        ...
        (new FrameDistribution("blocks satisfaction", data, 100, true))
            .setVisible(true);
      }
    });
