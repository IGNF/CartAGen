 ...
 * 
 */
public class RoadSectionSlopeRelation extends ObjectFieldRelation {
  /**
     */
  private double valeurCourante;

  public RoadSectionSlopeRelation(ReliefFieldAgent ac, SectionAgent tr) {
    super(ac, tr);
  }

  public RoadSectionSlopeRelation(SectionAgent tr) {
    super(
