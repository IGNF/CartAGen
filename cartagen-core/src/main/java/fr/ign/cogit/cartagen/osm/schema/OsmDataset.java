...
public class OsmDataset extends CartAGenDataSet {
  ...
  public IPopulation<ITreePoint> getTreePoints() {
    return (IPopulation<ITreePoint>) this
        .getCartagenPop(OsmDataset.TREE_POINT_POP, ITreePoint.FEAT_TYPE_NAME);
  }
  ...
  public IPopulation<ICycleWay> getCycleWays() {
    return (IPopulation<ICycleWay>) this.getCartagenPop(OsmDataset.CYCLEWAY_POP,
        INetworkSection.FEAT_TYPE_NAME);
  }
  ...
  public IPopulation<ICemetery> getCemeteries() {
    return (IPopulation<ICemetery>) this.getCartagenPop(OsmDataset.CEMETERY_POP,
        ICemetery.FEAT_TYPE_NAME);
  }
  ...
  public IPopulation<OsmHospital> getHospitals() {
    return (IPopulation<OsmHospital>) this
        .getCartagenPop(OsmDataset.HOSPITAL_POP, OsmHospital.FEAT_TYPE_NAME);
  }
