 ...
 * 
 */
public class MesoComponentsSatisfaction<ComponentClass extends GeographicObjectAgent>
   ...
   * @param importance
   */
  public MesoComponentsSatisfaction(GeographicObjectAgent agent,
      double importance) {
  ...
  public void computeCurrentValue() {
    this.componentsSatisfaction = ((MesoAgent<?>) this.getAgent())
