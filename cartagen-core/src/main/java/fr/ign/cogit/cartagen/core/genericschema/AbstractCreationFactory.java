...
import fr.ign.cogit.cartagen.core.genericschema.partition.IPartitionElement;
...
public abstract class AbstractCreationFactory {
	...
	public IBuilding createBuilding() {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for IBuilding");
		return null;
	}
	...
	@SuppressWarnings("unused")
	public IBuilding createBuilding(IPolygon poly, String nature, BuildingCategory category) {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for IBuilding");
		return null;
	}
	// BuildArea
	...
	public IBuildArea createBuildArea(IPolygon poly) {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for IBuildLine");
		return null;
	}
	...
	public IBuildPoint createBuildPoint() {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for IBuildPoint");
		return null;
	}
	...
	public IUrbanAlignment createUrbanAlignment() {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for IUrbanAlignment");
		return null;
	}
	...
	@SuppressWarnings("unused")
	public IUrbanAlignment createUrbanAlignment(List<IUrbanElement> urbanElements, ILineString shapeLine,
	...
	public IUrbanBlock createUrbanBlock() {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for IUrbanBlock");
		return null;
	}

	@SuppressWarnings("unused")
	public IUrbanBlock createUrbanBlock(Ilot block, CityPartition partition, StreetNetwork net,
	...
	@SuppressWarnings("unused")
	public IUrbanBlock createUrbanBlock(IPolygon poly, CityPartition partition, StreetNetwork net,
			Collection<IUrbanElement> buildings, Collection<IRoadLine> surroundRoads) {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for IUrbanBlock");
		return null;
	}
	...
	@SuppressWarnings("unused")
	public IUrbanBlock createUrbanBlock(IPolygon poly, IFeatureCollection<IUrbanElement> buildings,
	...
	@SuppressWarnings("unused")
	public IUrbanBlock createUrbanBlock(IPolygon poly, ITown town, IFeatureCollection<IUrbanElement> urbanElements,
			IFeatureCollection<INetworkSection> sections, CityPartition partition, StreetNetwork net) {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for IUrbanBlock");
		return null;
	}

	@SuppressWarnings("unused")
	public IUrbanBlock createUrbanBlock(Ilot block, CityPartition partition, StreetNetwork net, IPolygon geom,
			Set<IUrbanElement> buildings, Set<IRoadLine> surroundRoads) {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for IUrbanBlock");
		return null;
	}
	...
	public ITown createTown() {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for ITown");
		return null;
	}
	...
	public IEmptySpace createEmptySpace(IPolygon poly) {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for IEmptySpace");
		return null;
	}
	...
	public ISportsField createSportsField() {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for ISportsField");
		return null;
	}
	...
	public ICemetery createCemetery() {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for ICemetery");
		return null;
	}
	...
	public INetwork createNetwork() {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for INetwork");
		return null;
	}
	...
	public INetworkFace createNetworkFace(IPolygon poly) {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for INetworkFace");
		return null;
	}
	...
	public IRoadLine createRoadLine() {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for IRoadLine");
		return null;
	}
	...
	@SuppressWarnings("unused")
	public IRoadLine createRoadLine(TronconDeRoute geoxObj, int importance, int symbolId) {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for IRoadLine");
		return null;
	}
	...
	public IRoadNode createRoadNode() {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for IRoadNode");
		return null;
	}
	...
	public IRoadRoute createRoadRoute(ILineString line) {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for IRoadRoute");
		return null;
	}
	...
	public IRoadArea createRoadArea() {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for IRoadArea");
		return null;
	}
	...
	public IRoadFacilityPoint createRoadFacilityPoint() {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for IRoadFacilityPoint");
		return null;
	}
	...
	public IBranchingCrossroad createBranchingCrossroad() {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for IBranchingCrossroad");
		return null;
	}

	@SuppressWarnings("unused")
	public IBranchingCrossroad createBranchingCrossroad(PatteOie geoxObj, Collection<IRoadLine> roads,
	...
	public IRoundAbout createRoundAbout() {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for IRoundAbout");
		return null;
	}

	@SuppressWarnings("unused")
	public IRoundAbout createRoundAbout(RondPoint geoxObj, Collection<IRoadLine> roads, Collection<IRoadNode> nodes) {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for IRoundAbout");
		return null;
	}

	@SuppressWarnings("unused")
	public IRoundAbout createRoundAbout(IPolygon geom, Collection<IRoadLine> externalRoads,
	...
	public IInterchange createInterchange(IPolygon poly) {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for IInterchange");
		return null;
	}
	...
	public IDualCarriageWay createDualCarriageways(IPolygon poly, int importance) {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for IDualCarriageWay");
		return null;
	}

	@SuppressWarnings("unused")
	public IDualCarriageWay createDualCarriageways(IPolygon poly, int importance, Collection<IRoadLine> innerRoads) {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for IDualCarriageWay");
		return null;
	}
	...
	public IPathLine createPath(ILineString line, int importance) {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for IPath");
		return null;
	}
	...
	public IBridgePoint createBridgePoint(IPoint point) {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for IBridgePoint");
		return null;
	}
	...
	public IRoadStroke createRoadStroke(ILineString geom, RoadStroke stroke) {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for IRoadStroke");
		return null;
	}
	...
	public IRailwayLine createRailwayLine() {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for IRailwayLine");
		return null;
	}
	...
	public IElectricityLine createElectricityLine() {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for IElectricityLine");
		return null;
	}

	@SuppressWarnings("unused")
	public IElectricityLine createElectricityLine(ArcReseau geoxObj, int importance) {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for IElectricityLine");
		return null;
	}
	...
	public ICable createCable() {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for ICable");
		return null;
	}
	...
	public IRailwayNode createRailwayNode() {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for IRailwayNode");
		return null;
	}
	...
	public IRailwayRoute createRailwayRoute(ILineString line) {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for IRailwayRoute");
		return null;
	}
	...
	public ITriageArea createTriageArea() {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for ITriageArea");
		return null;
	}
	...
	public IWaterLine createWaterLine() {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for IWaterLine");
		return null;
	}
	...
	@SuppressWarnings("unused")
	public IWaterLine createWaterLine(TronconHydrographique geoxObj, int importance) {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for IWaterLine");
		return null;
	}
	...
	public IWaterCourse createWaterCourse(ILineString line) {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for IWaterCourse");
		return null;
	}
	...
	public IWaterNode createWaterNode() {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for IWaterNode");
		return null;
	}
	...
	public IWaterPoint createWaterPoint(IPoint point) {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for IWaterPoint");
		return null;
	}
	...
	public IWaterArea createWaterArea() {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for IWaterArea");
		return null;
	}
	...
	public IContourLine createContourLine() {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for IContourLine");
		return null;
	}
	...
	public ISpotHeight createSpotHeight(IPoint point, double value) {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for ISpotHeight");
		return null;
	}
	...
	public IDEMPixel createDEMPixel(double x, double y, double z) {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for IDEMPixel");
		return null;
	}
	...
	public IReliefField createReliefField(ChampContinu champ) {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for IReliefField");
		return null;
	}

	@SuppressWarnings("unused")
	public IReliefField createReliefField(Collection<IContourLine> contourLines) {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for IReliefField");
		return null;
	}
	...
	public IReliefElementPoint createReliefElementPoint(IPoint point) {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for IReliefElementPoint");
		return null;
	}

	@SuppressWarnings("unused")
	public IReliefElementPoint createReliefElementPoint(ElementCaracteristiqueDuRelief geoxObj) {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for IReliefElementPoint");
		return null;
	}
	...
	public IReliefElementLine createReliefElementLine(ILineString line) {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for IReliefElementLine");
		return null;
	}

	@SuppressWarnings("unused")
	public IReliefElementLine createReliefElementLine(ElementCaracteristiqueDuRelief geoxObj) {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for IReliefElementLine");
		return null;
	}
	...
	public IReliefElementArea createReliefElementArea(IPolygon poly) {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for IReliefElementArea");
		return null;
	}

	@SuppressWarnings("unused")
	public IReliefElementArea createReliefElementArea(ElementCaracteristiqueDuRelief geoxObj) {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for IReliefElementArea");
		return null;
	}
	...
	@SuppressWarnings("unused")
	public IReliefTriangle createReliefTriangle(IDirectPosition pt1, IDirectPosition pt2, IDirectPosition pt3) {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for IReliefTriangle");
		return null;
	}
	...
	public ISimpleLandUseArea createSimpleLandUseArea() {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for ISimpleLandUseArea");
		return null;
	}
	...
	public ICompositeLandUseArea createCompositeLandUseArea(IPolygon poly) {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for ICompositeLandUseArea");
		return null;
	}
	...
	public ILandUsePoint createLandUsePoint(IPoint point) {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for ILandUsePoint");
		return null;
	}
	...
	public ILandUseLine createLandUseLine(ILineString line) {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for ILandUseLine");
		return null;
	}
	...
	public ISimpleAdminUnit createSimpleAdminUnit(IPolygon poly) {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for ISimpleAdminUnit");
		return null;
	}

	@SuppressWarnings("unused")
	public ISimpleAdminUnit createSimpleAdminUnit(UniteAdministrativeElementaire geoxObj) {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for ISimpleAdminUnit");
		return null;
	}
	...
	public ICompositeAdminUnit createCompositeAdminUnit(IPolygon poly) {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for ICompositeAdminUnit");
		return null;
	}

	@SuppressWarnings("unused")
	public ICompositeAdminUnit createCompositeAdminUnit(UniteAdministrativeComposite geoxObj) {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for ICompositeAdminUnit");
		return null;
	}
	...
	public IAdminLimit createAdminLimit() {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for IAdminLimit");
		return null;
	}
	...
	public IAdminCapital createAdminCapital() {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for IAdminCapital");
		return null;
	}
	...
	public ILabelPoint createLabelPoint() {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for ILabelPoint");
		return null;
	}

	@SuppressWarnings("unused")
	public ILabelPoint createLabelPoint(IPoint point, LabelCategory category, String name, String nature,
			int importance) {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for ILabelPoint");
		return null;
	}
	...
	public IMiscPoint createMiscPoint() {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for IMiscPoint");
		return null;
	}
	...
	public IMiscLine createMiscLine() {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for IMiscLine");
		return null;
	}
	...
	public IMiscArea createMiscArea() {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for IMiscArea");
		return null;
	}
	...
	public IBoundedArea createBoundedArea() {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for IBoundedArea");
		return null;
	}
	...
	public IAirportArea createAirportArea(IPolygon geom) {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for IAirportArea");
		return null;
	}

	@SuppressWarnings("unused")
	public IRunwayArea createRunwayArea(IPolygon geom) {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for IRunwayArea");
		return null;
	}

	@SuppressWarnings("unused")
	public IRunwayLine createRunwayLine(ILineString geom) {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for IRunwayLine");
		return null;
	}

	@SuppressWarnings("unused")
	public ITaxiwayArea createTaxiwayArea(IPolygon simple, TaxiwayType type) {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for ITaxiwayArea");
		return null;
	}

	@SuppressWarnings("unused")
	public ITaxiwayLine createTaxiwayLine(ILineString geom, TaxiwayType type) {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for ITaxiwayLine");
		return null;
	}
	...
	public IMask createMask() {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for IMask");
		return null;
	}
	...
	public ICycleWay createCycleWay(ILineString line) {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for ICycleWay");
		return null;
	}

	@SuppressWarnings("unused")
	public ICoastLine createCoastLine(ILineString line) {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for ICoastLine");
		return null;
	}
	...
	@SuppressWarnings("unused")
	public IPartitionElement createPartitionElement(IPolygon poly) {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for ICoastLine");
		return null;
	}

	@SuppressWarnings("unused")
	public IPartitionElement createPartitionElement() {
		AbstractCreationFactory.logger.error("Non implemented creation factory method for ICoastLine");
		return null;
	}
}
