...
public class OsmMapping {
  ...
  public OsmMapping() {
    ...
    // building matching
    this.matchings.add(
        new OsmMatching("building", IBuilding.class, GeometryType.POLYGON));
    // sports fields matching
    this.matchings.add(
        new OsmMatching("sport", ISportsField.class, GeometryType.POLYGON));
    // rivers matching
    ...
    // shops matchings
    this.matchings.add(
        new OsmMatching("shop", IPointOfInterest.class, GeometryType.POINT));
    this.matchings.add(
        new OsmMatching("amenity", IPointOfInterest.class, GeometryType.POINT));
    OsmMatching busmatching = new OsmMatching("highway", IPointOfInterest.class,
        GeometryType.POINT);
    ...
    // cable matching
    this.matchings
        .add(new OsmMatching("aerialway", ICable.class, GeometryType.LINE));
    // railways
    this.matchings
        .add(new OsmMatching("railway", IRailwayLine.class, GeometryType.LINE));
    ...
    OsmMatching farmMatch = new OsmMatching("landuse", ISimpleLandUseArea.class,
        GeometryType.POLYGON);
    farmMatch.addTagValue("farmland");
    farmMatch.addTagValue("farm");
    this.matchings.add(farmMatch);
    OsmMatching commMatch = new OsmMatching("landuse", ISimpleLandUseArea.class,
        GeometryType.POLYGON);
    ...
    // coastlines
    OsmMatching coastlineMatching = new OsmMatching("natural", ICoastLine.class,
        GeometryType.LINE);
    ...
    // cemeteries
    OsmMatching cemeteryMatching = new OsmMatching("landuse", OsmCemetery.class,
        GeometryType.POLYGON);
    ...
    // hospitals
    OsmMatching hospitalMatching = new OsmMatching("amenity", OsmHospital.class,
        GeometryType.POLYGON);
