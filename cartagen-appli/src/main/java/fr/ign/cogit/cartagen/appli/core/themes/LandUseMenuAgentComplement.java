...
public class LandUseMenuAgentComplement {
    ...
    private Logger logger = Logger.getLogger(LandUseMenuAgentComplement.class.getName());
    ...
    public JCheckBoxMenuItem mSegmentsOccSolVoir = new JCheckBoxMenuItem("Display segments");
    public JCheckBoxMenuItem mPointsOccSolVoir = new JCheckBoxMenuItem("Display points");
    ...
    private class LoadLandUseAction extends AbstractAction {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            LandUseMenuAgentComplement.this.logger.info("Chargement de "
                    + AgentUtil.getAgentFromGeneObj(CartAGenDoc.getInstance().getCurrentDataset().getLandUseField()));
    ...
    private class DisplayInfoAction extends AbstractAction {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            ((LandUseFieldAgent) AgentUtil
                    .getAgentFromGeneObj(CartAGenDoc.getInstance().getCurrentDataset().getLandUseField()))
                            .printInfosConsole();
            System.out.println("----end field info-----");
        }

        public DisplayInfoAction() {
            this.putValue(Action.SHORT_DESCRIPTION, "Display information on the land use agent");
