...
public class GraphFactory {
    ...
    /**
     * Same as buildGraphFromNetwork but returns a
     * {@link GeographicNetworkGraph} instead of just the graph, which can be
     * helpful to get the {@link IFeature} instances related to a graph edge.
     * 
     * @param network
     * @param graphWeighter
     * @return
