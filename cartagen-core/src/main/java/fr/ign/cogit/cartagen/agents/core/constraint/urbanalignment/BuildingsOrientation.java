...
import fr.ign.cogit.cartagen.agents.core.action.urbanalignment.BuildingsOrientationAction;
 ...
 * 
 */
public class BuildingsOrientation extends GeographicObjectConstraintImpl {

  /**
   */
  private double buildingsMeanOrientationFactor;

  public BuildingsOrientation(GeographicObjectAgentGeneralisation agent,
      double importance) {
  ...
  public void computeCurrentValue() {
    this.buildingsMeanOrientationFactor = ((UrbanAlignmentAgent) this
        .getAgent()).getBuildingsMeanOrientationFactor();
  }
  ...
  public void computeSatisfaction() {
    ...
    int s = 100 - (int) (this.buildingsMeanOrientationFactor / 5);
    if (s < 0) {
  ...
  public Set<ActionProposal> getActions() {
    ...
    Action actionToPropose = new BuildingsOrientationAction(
