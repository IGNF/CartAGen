...
public class CartAGenDataSet extends DataSet {
	...
	public static final String PARTITION_ELTS_POP = "partitionElements";
	...
	public String getPopNameFromObj(IFeature obj) {
		...
		} else if (obj instanceof IPartitionElement) {
			return CartAGenDataSet.PARTITION_ELTS_POP;
		}
		return null;
	}
	...
	public String getPopNameFromFeatType(String featureType) {
		if (featureType.equals(IBuilding.FEAT_TYPE_NAME)) {
			...
			return CartAGenDataSet.EMBANKMENT_POP;
		} else if (featureType.equals(IPartitionElement.FEAT_TYPE_NAME)) {
			return CartAGenDataSet.PARTITION_ELTS_POP;
		}
		return null;
	}
	...
	public String getPopNameFromClass(Class<?> classObj) {
		if (IBuilding.class.isAssignableFrom(classObj)) {
			...
			return CartAGenDataSet.EMBANKMENT_POP;
		} else if (IPartitionElement.class.isAssignableFrom(classObj)) {
			return CartAGenDataSet.PARTITION_ELTS_POP;
		}
		return null;
	}
	...
	public IPopulation<? extends IGeneObj> getCartagenPop(String nomPopulation, String featureTypeName) {
	...
	public IPopulation<IGeneObj> getCartagenPop(String nomPopulation) {
		IPopulation<IGeneObj> pop = (IPopulation<IGeneObj>) super.getPopulation(nomPopulation);
		return pop;
	}
	...
	public IPopulation<IBuilding> getBuildings() {
		return (IPopulation<IBuilding>) this.getCartagenPop(CartAGenDataSet.BUILDINGS_POP, IBuilding.FEAT_TYPE_NAME);
	}
	...
	public IPopulation<IUrbanBlock> getBlocks() {
		return (IPopulation<IUrbanBlock>) this.getCartagenPop(CartAGenDataSet.BLOCKS_POP, IUrbanBlock.FEAT_TYPE_NAME);
	}
	...
	public IPopulation<ITown> getTowns() {
		return (IPopulation<ITown>) this.getCartagenPop(CartAGenDataSet.TOWNS_POP, ITown.FEAT_TYPE_NAME);
	}
	...
	public IPopulation<IUrbanAlignment> getUrbanAlignments() {
		return (IPopulation<IUrbanAlignment>) this.getCartagenPop(CartAGenDataSet.URBAN_ALIGNMENTS_POP,
				IUrbanAlignment.FEAT_TYPE_NAME);
	}
	...
	public IPopulation<IRoadLine> getRoads() {
		return (IPopulation<IRoadLine>) this.getCartagenPop(CartAGenDataSet.ROADS_POP, IRoadLine.FEAT_TYPE_NAME);
	}
	...
	public IPopulation<IRoadNode> getRoadNodes() {
		return (IPopulation<IRoadNode>) this.getCartagenPop(CartAGenDataSet.ROAD_NODES_POP, IRoadNode.FEAT_TYPE_NAME);
	}
	...
	public IPopulation<IPathLine> getPaths() {
		return (IPopulation<IPathLine>) this.getCartagenPop(CartAGenDataSet.PATHS_POP, IPathLine.FEAT_TYPE_NAME);
	}
	...
	public IPopulation<IWaterLine> getWaterLines() {
		return (IPopulation<IWaterLine>) this.getCartagenPop(CartAGenDataSet.WATER_LINES_POP,
				IWaterLine.FEAT_TYPE_NAME);
	}
	...
	public IPopulation<IWaterNode> getWaterNodes() {
		return (IPopulation<IWaterNode>) this.getCartagenPop(CartAGenDataSet.WATER_NODES_POP,
				IWaterNode.FEAT_TYPE_NAME);
	}
	...
	public IPopulation<IWaterArea> getWaterAreas() {
		return (IPopulation<IWaterArea>) this.getCartagenPop(CartAGenDataSet.WATER_AREAS_POP,
				IWaterArea.FEAT_TYPE_NAME);
	}
	...
	public IPopulation<IRailwayLine> getRailwayLines() {
		return (IPopulation<IRailwayLine>) this.getCartagenPop(CartAGenDataSet.RAILWAY_LINES_POP,
	...
	public IPopulation<IElectricityLine> getElectricityLines() {
		return (IPopulation<IElectricityLine>) this.getCartagenPop(CartAGenDataSet.ELECTRICITY_LINES_POP,
	...
	public IPopulation<IContourLine> getContourLines() {
		return (IPopulation<IContourLine>) this.getCartagenPop(CartAGenDataSet.CONTOUR_LINES_POP,
				IContourLine.FEAT_TYPE_NAME);
	}
	...
	public IPopulation<IReliefElementLine> getReliefLines() {
		return (IPopulation<IReliefElementLine>) this.getCartagenPop(CartAGenDataSet.RELIEF_LINES_POP,
	...
	public IPopulation<ISpotHeight> getSpotHeights() {
		return (IPopulation<ISpotHeight>) this.getCartagenPop(CartAGenDataSet.SPOT_HEIGHTS_POP,
				ISpotHeight.FEAT_TYPE_NAME);
	}
	...
	public IPopulation<IDEMPixel> getDEMPixels() {
		return (IPopulation<IDEMPixel>) this.getCartagenPop(CartAGenDataSet.DEM_PIXELS_POP, IDEMPixel.FEAT_TYPE_NAME);
	}
	...
	public IPopulation<ISimpleLandUseArea> getLandUseAreas() {
		return (IPopulation<ISimpleLandUseArea>) this.getCartagenPop(CartAGenDataSet.LANDUSE_AREAS_POP,
	...
	public IFeatureCollection<ISimpleLandUseArea> getLandUseAreas(int type) {
		...
		for (IGeneObj obj : this.getCartagenPop(CartAGenDataSet.LANDUSE_AREAS_POP, ISimpleLandUseArea.FEAT_TYPE_NAME)) {
	...
	public IPopulation<IGeneObj> getAdminAreas() {
		return (IPopulation<IGeneObj>) this.getCartagenPop(CartAGenDataSet.ADMIN_FIELDS_POP, IGeneObj.FEAT_TYPE_NAME);
	}
	...
	public IPopulation<INetworkFace> getNetworkFaces() {
		return (IPopulation<INetworkFace>) this.getCartagenPop(CartAGenDataSet.NETWORK_FACES_POP,
				INetworkFace.FEAT_TYPE_NAME);
	}
	...
	public IPopulation<SpecialPoint> getSpecialPoints() {
		...
		return (IPopulation<SpecialPoint>) this.getCartagenPop(CartAGenDataSet.SPECIAL_POINTS_POP,
				SpecialPoint.FEAT_TYPE_NAME);
	...
	public IPopulation<IRoadStroke> getRoadStrokes() {
		return (IPopulation<IRoadStroke>) this.getCartagenPop(CartAGenDataSet.ROAD_STROKES_POP,
				IRoadStroke.FEAT_TYPE_NAME);
	}
	...
	public IPopulation<IRoundAbout> getRoundabouts() {
		return (IPopulation<IRoundAbout>) this.getCartagenPop(CartAGenDataSet.ROUNDABOUTS_POP,
				IRoundAbout.FEAT_TYPE_NAME);
	}
	...
	public IPopulation<IBranchingCrossroad> getBranchings() {
		return (IPopulation<IBranchingCrossroad>) this.getCartagenPop(CartAGenDataSet.BRANCHINGS_POP,
				IBranchingCrossroad.FEAT_TYPE_NAME);
	}
	...
	public IPopulation<IMask> getMasks() {
		return (IPopulation<IMask>) this.getCartagenPop(CartAGenDataSet.MASK, IMask.FEAT_TYPE_NAME);
	}
	...
	public IPopulation<IAirportArea> getAirports() {
		return (IPopulation<IAirportArea>) this.getCartagenPop(CartAGenDataSet.AIRPORT_AREA_POP,
				IAirportArea.FEAT_TYPE_NAME);
	}
	...
	public IPopulation<IRunwayArea> getRunways() {
		return (IPopulation<IRunwayArea>) this.getCartagenPop(CartAGenDataSet.RUNWAY_AREA_POP,
				IRunwayArea.FEAT_TYPE_NAME);
	}
	...
	public IPopulation<IRunwayLine> getRunwayLines() {
		return (IPopulation<IRunwayLine>) this.getCartagenPop(CartAGenDataSet.RUNWAY_LINE_POP,
				IRunwayLine.FEAT_TYPE_NAME);
	}
	...
	public IPopulation<ITaxiwayLine> getTaxiwayLines() {
		return (IPopulation<ITaxiwayLine>) this.getCartagenPop(CartAGenDataSet.TAXIWAY_LINE_POP,
				ITaxiwayLine.FEAT_TYPE_NAME);
	}
	...
	public IPopulation<ITaxiwayArea> getTaxiwayAreas() {
		return (IPopulation<ITaxiwayArea>) this.getCartagenPop(CartAGenDataSet.TAXIWAY_AREA_POP,
				ITaxiwayArea.FEAT_TYPE_NAME);
	}
	...
	public IPopulation<IRiverSimpleIsland> getIslands() {
		return (IPopulation<IRiverSimpleIsland>) this.getCartagenPop(CartAGenDataSet.WATER_ISLAND_POP,
				IRiverSimpleIsland.FEAT_TYPE_NAME);
	}
	...
	public IPopulation<IAdminLimit> getAdminLimits() {
		return (IPopulation<IAdminLimit>) this.getCartagenPop(CartAGenDataSet.ADMIN_LIMIT_POP,
				IAdminLimit.FEAT_TYPE_NAME);
	}
	...
	public IPopulation<ISimpleAdminUnit> getAdminUnits() {
		return (IPopulation<ISimpleAdminUnit>) this.getCartagenPop(CartAGenDataSet.ADMIN_UNIT_POP,
				ISimpleAdminUnit.FEAT_TYPE_NAME);
	}
	...
	public IPopulation<IBuildPoint> getBuildPts() {
		return (IPopulation<IBuildPoint>) this.getCartagenPop(CartAGenDataSet.BUILD_PT_POP, IBuildPoint.FEAT_TYPE_NAME);
	}
	...
	public IPopulation<IBuildArea> getBuildAreas() {
		return (IPopulation<IBuildArea>) this.getCartagenPop(CartAGenDataSet.BUILD_AREA_POP, IBuildArea.FEAT_TYPE_NAME);
	}
	...
	public IPopulation<ISportsField> getSportsFields() {
		return (IPopulation<ISportsField>) this.getCartagenPop(CartAGenDataSet.SPORTS_FIELDS_POP,
				ISportsField.FEAT_TYPE_NAME);
	}
	...
	public IPopulation<IReliefElementPoint> getReliefPts() {
		return (IPopulation<IReliefElementPoint>) this.getCartagenPop(CartAGenDataSet.RELIEF_PTS_POP,
				IReliefElementPoint.FEAT_TYPE_NAME);
	}
	...
	public IPopulation<IPointOfInterest> getPOIs() {
		return (IPopulation<IPointOfInterest>) this.getCartagenPop(CartAGenDataSet.POI_POP,
				IPointOfInterest.FEAT_TYPE_NAME);
	}
	...
	public IPopulation<IBridgePoint> getBridgePoints() {
		return (IPopulation<IBridgePoint>) this.getCartagenPop(CartAGenDataSet.BRIDGE_PT_POP,
				IBridgePoint.FEAT_TYPE_NAME);
	}
	...
	public IPopulation<ICoastLine> getCoastlines() {
		return (IPopulation<ICoastLine>) this.getCartagenPop(CartAGenDataSet.COASTLINE_POP, ICoastLine.FEAT_TYPE_NAME);
	}
	...
	public IPopulation<ISquareArea> getSquareAreas() {
		return (IPopulation<ISquareArea>) this.getCartagenPop(CartAGenDataSet.SQUARE_AREA_POP,
				ISquareArea.FEAT_TYPE_NAME);
	}
	...
	public IPopulation<ICemetery> getCemeteries() {
		return (IPopulation<ICemetery>) this.getCartagenPop(CartAGenDataSet.CEMETERY_POP, ICemetery.FEAT_TYPE_NAME);
	}
	...
	public IPopulation<ILabelPoint> getLabelPoints() {
		return (IPopulation<ILabelPoint>) this.getCartagenPop(CartAGenDataSet.LABEL_PT_POP, ILabelPoint.FEAT_TYPE_NAME);
	}
	...
	public IPopulation<IEmbankmentLine> getEmbankmentLines() {
		return (IPopulation<IEmbankmentLine>) this.getCartagenPop(CartAGenDataSet.EMBANKMENT_POP,
				IEmbankmentLine.FEAT_TYPE_NAME);
	}
	...
	public INetwork getRoadNetwork() {
		if (this.roadNetwork == null) {
			this.roadNetwork = this.getCartAGenDB().getGeneObjImpl().getCreationFactory()
	...
	public IReliefField getReliefField() {
		if (this.reliefField == null) {
			synchronized (CartAGenDataSet.class) {
				if (this.reliefField == null) {
					this.reliefField = this.getCartAGenDB().getGeneObjImpl().getCreationFactory()
							.createReliefField(new ChampContinuImpl());
				}
			}
		}
	...
	public INetwork getHydroNetwork() {
		if (this.hydroNetwork == null) {
			this.hydroNetwork = this.getCartAGenDB().getGeneObjImpl().getCreationFactory()
					.createNetwork(new ReseauImpl());
	...
	public INetwork getRailwayNetwork() {
		if (this.railwayNetwork == null) {
			this.railwayNetwork = this.getCartAGenDB().getGeneObjImpl().getCreationFactory()
					.createNetwork(new ReseauImpl());
		}
	...
	public INetwork getElectricityNetwork() {
		if (this.electricityNetwork == null) {
			this.electricityNetwork = this.getCartAGenDB().getGeneObjImpl().getCreationFactory()
					.createNetwork(new ReseauImpl());
		}
	...
	/**
	 * Get the good network feature (e.g. road network, river network) from a class
	 * instance.
	 * 
	 * @param classObj
	 * @return
	...
	public void saveRoadLinesInSHP(String chemin) {
		...
		try {
			...
			for (IRoadLine section : CartAGenDoc.getInstance().getCurrentDataset().getRoads()) {
				coll.add(section);
			}
