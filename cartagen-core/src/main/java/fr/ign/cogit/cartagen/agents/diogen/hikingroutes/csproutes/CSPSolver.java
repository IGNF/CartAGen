...
public class CSPSolver {
   ...
   */
  public static void LaunchCSPSolver(HikingDataset data, int algorithmChoice) {

    // algorithmChoice == 2 means it s a backtracking with side constraints
    RoadStrokeForRoutes[] strokes = sortStrokes(data.getSelectedRouteStrokes(),
        algorithmChoice == 2);
