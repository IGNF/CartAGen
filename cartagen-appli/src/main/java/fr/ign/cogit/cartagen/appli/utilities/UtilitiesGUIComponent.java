...
import fr.ign.cogit.cartagen.appli.core.geoxygene.bookmarks.LoadBookmarkFrame;
import fr.ign.cogit.cartagen.appli.core.geoxygene.selection.AttributeQueryAction;
...
public class UtilitiesGUIComponent extends JMenu {
    ...
    /**
     * Action that allows to save the current window view as a bookmark, and
    ...
    class SaveBookmark extends AbstractAction {
        ...
        public SaveBookmark() {
            putValue(Action.SHORT_DESCRIPTION, "Save the current window view as a bookmark, stored in XML");
            putValue(Action.NAME, "Bookmark window");
        }
    }

    /**
     * Action that allows to load a previously stored in XML bookmark, and to
     * move the current window to the bookmark extents.
     * 
     * @author GTouya
     * 
     */
    class GoToBookmark extends AbstractAction {
        ...
        public GoToBookmark() {
            putValue(Action.SHORT_DESCRIPTION, "Go to a bookmark previously stored in XML file");
    ...
    class InternationalisationAction extends AbstractAction {
        ...
        public InternationalisationAction() {
            putValue(Action.SHORT_DESCRIPTION, I18N.getString("MainLabels.changeLanguageDescr"));
    ...
    class ShowWktAction extends AbstractAction {
        ...
        public ShowWktAction() {
            putValue(Action.SHORT_DESCRIPTION, I18N.getString("Draw a WKT (String) geometry in the geometry pool"));
