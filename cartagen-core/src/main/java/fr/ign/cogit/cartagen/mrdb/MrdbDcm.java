...
public class MrdbDcm extends DigitalCartographicModel {
  ...
  public Interval<Integer> getClassScaleRange(
      Class<? extends IGeneObj> classObj) {
    return classInformation.get(classObj).getScaleRange();
  }

  public MRDBPointOfView getClassPointOfView(
      Class<? extends IGeneObj> classObj) {
  ...
  public void addMrdbInformation(Class<? extends IGeneObj> classObj,
    ...
    this.classInformation.put(classObj,
        new MrdbClassInfo(scaleRange, pointOfView));
  }
