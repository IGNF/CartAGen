 ...
 * 
 */
public class HydroSectionChannelRelation extends ObjectFieldRelation {
  /**
     */
  private double valeurCourante;

  public HydroSectionChannelRelation(ReliefFieldAgent ac, SectionAgent tr) {
    super(ac, tr);
  }

  public HydroSectionChannelRelation(SectionAgent tr) {
    super(
