...
import fr.ign.cogit.cartagen.agents.core.action.block.BlockBuildingsDisplacementRandomAction;
...
public class Proximity extends GeographicObjectConstraintImpl {
	...
	public Proximity(GeographicObjectAgentGeneralisation agent, double importance) {
		super(agent, importance);
	}

	@Override
	public void computeCurrentValue() {
		this.overlappingRatesMean = ((BlockAgent) this.getAgent()).getBuildingsOverlappingRateMean();
	}
	...
	public Set<ActionProposal> getActions() {
		...
		actionToPropose = new BlockBuildingsDisplacementRuasAction((BlockAgent) this.getAgent(), this, 4.0,
		...
		actionToPropose = new BlockBuildingsDisplacementRandomAction((BlockAgent) this.getAgent(), this, 3.0);
		...
		actionToPropose = new BlockBuildingsDeletionProximityAction((BlockAgent) this.getAgent(), this, 1.0);
