...
public class EvaluationComponent extends JMenu {
    ...
    class GridEdgeDensityClutterAction extends AbstractAction {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            TiledImage pImage = new TiledImage(image, true);
            RasterClutterMethod clutterMethod = new RasterClutterMethod(pImage);
            Map<Integer, Map<Integer, Double>> result = clutterMethod.getGridEdgeDensityClutter(10);
        ...
        public GridEdgeDensityClutterAction() {
            ...
            this.putValue(Action.NAME, "Compute a Grid Edge Density Clutter of the map");
        }
    }
    ...
    class TopferAction extends AbstractAction {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            try {
                ...
                WritableSheet sheet = workbook.createSheet("radical_law_" + String.valueOf(finalScale), 1);
                ...
                for (Layer layer : sld.getLayers()) {
                    ...
                    Collection<IGeneObj> objects = SelectionUtil.getWindowObjects(application, layer.getName());
                    ...
                    double radicalNumber = objects.size() * Math.sqrt(initialScale / finalScale);
        ...
        public TopferAction() {
            ...
            this.putValue(Action.NAME, "Compute Topfer radical law on ungeneralised data");
        }
    }
    ...
    class ComputeMonitorsAction extends AbstractAction {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            Set<GeneralisationConcept> concepts = GeneralisationConcept.ontologyToGeneralisationConcepts(onto);

            // compute the constraint monitors
            try {
                SchemaAnnotation annotation = new SchemaAnnotation(pathAnnotation, concepts);
                ConstraintsInstanciation instanciation = new ConstraintsInstanciation(pathInst, concepts);
                ComputeMonitorsFrame frame = new ComputeMonitorsFrame(application, instanciation, annotation);
