...
public class CollaGenEnvironment {
	...
	private CollaGenEnvironment() {
		...
		this.relations = new FT_FeatureCollection<>();
	}

	/**
	 * Méthode permettant de renvoyer une instance de la classe CollaGenEnvironment
	 * 
	...
	public void setConstraintsInstanciation(ConstraintsInstanciation constraintsInstanciation) {
	...
	public void setConstraintsMonitors(IFeatureCollection<ConstraintMonitor> constraintsPopulation) {
	...
	/**
	 * Get the {@link GeoSpaceConcept} object that is named as the name parametered
	 * or that contains the name parameter in one of its labels (which is useful to
	 * use multi-language ontologies and keep the code in english).
	 * 
	 * @param name
	 * @return
	 */
