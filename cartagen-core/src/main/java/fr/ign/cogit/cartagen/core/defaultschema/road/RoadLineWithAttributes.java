...
public class RoadLineWithAttributes extends NetworkSection
    ...
    public Object getAttribute(String nom) {
        ...
        for (int i = 0; i < this.getFeatureType().getFeatureAttributes()
                .size(); i++) {
            GF_AttributeType attType = this.getFeatureType()
    ...
    /**
     * met la valeur value dans la case rang de la table d'attributs. Pour
     * éviter toute erreur, mieux vaut utiliser setAttribute(String nom, Object
     * value) qui va chercher dans le schema l'emplacement correct de
     * l'attribut.
     * 
     * @param rang
     * @param value
    ...
    public void setAttribute(GF_AttributeType attType, Object valeur) {
        ...
        for (int i = 0; i < this.getFeatureType().getFeatureAttributes()
            ...
            if (attTypeTemp.getMemberName().equals(attType.getMemberName())) {
                ...
                /*
                 * ((TronconDeRouteImplWithAttributes)
                 * this.getGeoxObj()).setAttribute( attType, valeur);
                 */
                return;
            }
        ...
        logger.error(
                "The attribut " + attType.getMemberName() + " is not found");
    }
    ...
    public void setFeatureType(GF_FeatureType featureType) {
        ...
        this.setAttributes(
                new Object[featureType.getFeatureAttributes().size()]);
