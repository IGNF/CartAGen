...
public class HydroNetworkMenu extends JMenu {
    ...
    private class EnrichHydroNetAction extends AbstractAction {
        ...
        public void actionPerformed(ActionEvent e) {
            HydroNetworkMenu.this.logger.info("Enrichment of " + CartAGenDoc
                    .getInstance().getCurrentDataset().getHydroNetwork());
            ...
            if (net.getSections().size() == 0) {
                ...
                for (IWaterLine w : CartAGenDoc.getInstance()
                        .getCurrentDataset().getWaterLines()) {
                    sections.add(w);
                }
    ...
    private class SelectSectionsAction extends AbstractAction {
        ...
        @Override
        public void actionPerformed(ActionEvent e) {
            HydroNetworkMenu.this.logger.info("Selection of " + CartAGenDoc
                    .getInstance().getCurrentDataset().getHydroNetwork());
            for (IWaterLine section : CartAGenDoc.getInstance()
                    .getCurrentDataset().getWaterLines()) {
    ...
    private class NetworkSelectionAction extends AbstractAction {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            RiverNetworkSelection selection = new RiverNetworkSelection(2,
                    2000.0, 50000.0, true);
