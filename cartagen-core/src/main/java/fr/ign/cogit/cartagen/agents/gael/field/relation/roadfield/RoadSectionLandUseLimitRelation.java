 ...
 */
package fr.ign.cogit.cartagen.agents.gael.field.relation.roadfield;
 ...
 * 
 */
public class RoadSectionLandUseLimitRelation extends ObjectFieldRelation {
  /**
     */
  private double valeurCourante;

  public RoadSectionLandUseLimitRelation(ReliefFieldAgent ac, SectionAgent tr) {
    super(ac, tr);
  }

  public RoadSectionLandUseLimitRelation(SectionAgent tr) {
    super(
