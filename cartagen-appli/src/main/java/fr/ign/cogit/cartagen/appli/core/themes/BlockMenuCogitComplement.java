...
public class BlockMenuCogitComplement extends JMenu {
    ...
    private Logger logger = Logger.getLogger(BlockMenuCogitComplement.class.getName());

    private JLabel lblCogit = new JLabel("          COGIT");

    private JMenuItem mSuppressionBatimentsDensite = new JMenuItem(new DeleteBuildingsDensityAction());
    private JMenuItem mSuppressionBatimentsSize = new JMenuItem(new DeleteBuildingsSizeAction());
    private JMenuItem mDeplacementBatimentsRandom = new JMenuItem(new DisplaceBuildingsRandAction());
    private JMenuItem mDeplacementBatimentsRuas = new JMenuItem(new DisplaceBuildingsRuasAction());
    private JMenuItem mAgregationBatiments = new JMenuItem(new Aggregate2BuildingsAction());
    ...
    private class DeleteBuildingsDensityAction extends AbstractAction {
            ...
            Thread th = new Thread(new Runnable() {
                ...
                public void run() {
                    for (IFeature sel : SelectionUtil
                        ...
                        BlockMenuCogitComplement.this.logger.info("Suppression des bâtiments de l'îlot " + sel);
        ...
        public DeleteBuildingsDensityAction() {
            this.putValue(Action.SHORT_DESCRIPTION, "Trigger Delete buildings algorithm on the selected block agents");
            ...
            Thread th = new Thread(new Runnable() {
                ...
                public void run() {
                    for (IFeature sel : SelectionUtil
                        ...
                        BlockMenuCogitComplement.this.logger.info("Suppression (2) des bâtiments de l'îlot " + sel);
            ...
            Thread th = new Thread(new Runnable() {
                ...
                public void run() {
                    for (IFeature sel : SelectionUtil
                        ...
                        IUrbanBlock ai = (IUrbanBlock) sel;
                        BlockMenuCogitComplement.this.logger.info("Déplacement des bâtiments de l'îlot " + sel);
            ...
            Thread th = new Thread(new Runnable() {
                ...
                public void run() {
                    for (IFeature sel : SelectionUtil
                        ...
                        IUrbanBlock ai = (IUrbanBlock) sel;
                        BlockMenuCogitComplement.this.logger.info("Agregation de 2 bâtiments de l'îlot " + ai);
                        BuildingsAggregation.computeBlockAggregation(ai);
                        BlockMenuCogitComplement.this.logger.info(" fin");
                    }
                }
            });
    ...
    private class TriangulateAction extends AbstractAction {
            ...
            Thread th = new Thread(new Runnable() {
                ...
                public void run() {
                    for (IFeature sel : SelectionUtil
                        ...
                        BlockMenuCogitComplement.this.logger.info("Triangulation de l'îlot " + sel);
        ...
        public TriangulateAction() {
            this.putValue(Action.SHORT_DESCRIPTION, "Trigger Delaunay Triangulation in the selected block agents");
