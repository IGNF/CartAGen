...
public abstract class InternStructureAgentGeneralisation extends
  ...
  public void ajouterContrainteSatisfactionComposantsStructure(
      double importance) {
    new StructureComponentsSatisfaction(this, importance);
  }
  ...
  public double getComponentsSatisfaction() {
    ...
    double s = sum / nb;
    if (s > 100) {
      InternStructureAgentGeneralisation.logger.warn(
  ...
  public void ajouterContrainteSatisfactionComposants(double importance) {
    new MesoComponentsSatisfaction<GeographicObjectAgent>(this, importance);
  }
