 ...
 * 
 */
public final class CartAGenRightPanel extends JPanel implements MouseListener, MouseMotionListener {
    ...
    public CartAGenRightPanel(MainFrame frame) {
        ...
        this.pMouseTracking.setBorder(BorderFactory.createTitledBorder("Mouse Tracking"));
        ...
        this.bSelectionCenterAndZoom.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent arg0) {
                IFeatureCollection<IFeature> fc = new FT_FeatureCollection<IFeature>(
                        getFrame().getSelectedProjectFrame().getLayerViewPanel().getSelectedFeatures());
                try {
                    CartAGenRightPanel.this.getFrame().getSelectedProjectFrame().getLayerViewPanel().getViewport()
                            .zoom(fc.envelope());
        ...
        this.bSelectionSuppression.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent arg0) {
                for (IFeature sel : getFrame().getSelectedProjectFrame().getLayerViewPanel().getSelectedFeatures()) {
        ...
        this.bEmptySelection.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent arg0) {
                getFrame().getSelectedProjectFrame().getLayerViewPanel().getSelectedFeatures().clear();
        ...
        // ((AbstractMainFrame)
        // frame).getCurrentDesktop().addMouseListener(this);
    }

    @Override
    public void mouseClicked(MouseEvent e) {
        this.lNbSelection
                .setText("Nb=" + String.valueOf(SelectionUtil.getSelectedObjects(frame.getApplication()).size()));
        this.validate();
    }
    ...
    public void mouseMoved(MouseEvent e) {
        if (this.trackMouse.isSelected()) {
            ...
            Point pt = e.getPoint();
            try {
                IDirectPosition pos = getFrame().getSelectedProjectFrame().getLayerViewPanel().getViewport()
                        .toModelDirectPosition(pt);
