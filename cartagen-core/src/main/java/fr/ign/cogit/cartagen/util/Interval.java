...
public class Interval<T extends Number>
    implements Cloneable, Comparable<Interval<T>> {
  ...
  public boolean equals(Interval<?> interval) {
    return ((interval != null)
        ...
        && (this.minimumRule == interval.minimumRule)
        && (this.maximumRule == interval.maximumRule));
  }
  ...
  public boolean contains(Number number) throws IllegalArgumentException {
    ...
    boolean containsMin = (this.minimumRule == Rule.INCLUSIVE)
        ? (this.minimum.doubleValue() <= number.doubleValue())
        : (this.minimum.doubleValue() < number.doubleValue());
    boolean containsMax = (this.maximumRule == Rule.INCLUSIVE)
   ...
   */
  public static double project(Number number, Interval<? extends Number> source,
      Interval<? extends Number> destination) throws IllegalArgumentException {
    if (number == null) {
      throw new IllegalArgumentException("Value cannot be null.");
    } else if (source == null) {
      throw new IllegalArgumentException("Source interval cannot be null.");
      ...
      throw new IllegalArgumentException(
          "Destination interval cannot be null.");
    }
