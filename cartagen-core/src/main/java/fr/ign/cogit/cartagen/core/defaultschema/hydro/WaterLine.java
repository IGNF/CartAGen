...
public class WaterLine extends NetworkSection implements IWaterLine {
	...
	public WaterLine() {
		super();
		this.geoxObj = new TronconHydrographiqueImpl(new ReseauImpl(), false, null, 0);
	}
	...
	public void restoreGeoxObjects() {
		this.geoxObj = new TronconHydrographiqueImpl(new ReseauImpl(), false, this.getGeom(), this.getImportance());
