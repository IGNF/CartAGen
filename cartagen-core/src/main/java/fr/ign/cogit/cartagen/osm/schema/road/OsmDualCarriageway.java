...
/**
 * An OSM implementation for dual carriageways
 * @author gtouya
 *
 */
public class OsmDualCarriageway extends OsmGeneObjSurf
    implements IDualCarriageWay {
   ...
   * Constructor
   */
  public OsmDualCarriageway(CarrefourComplexe geoxObj) {
    super();
  ...
  public OsmDualCarriageway(IPolygon poly) {
    super();
  ...
  public OsmDualCarriageway(IPolygon poly, int importance) {
    super();
    this.geoxObj = new CarrefourComplexeImpl();
    this.geoxObj.setGeom(poly);
    this.setInitialGeom(poly);
