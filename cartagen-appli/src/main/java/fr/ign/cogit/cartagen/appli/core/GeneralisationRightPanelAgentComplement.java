 ...
 */
public class GeneralisationRightPanelAgentComplement {

  static Logger logger = Logger
      .getLogger(GeneralisationRightPanelAgentComplement.class.getName());
  ...
  public JCheckBox cAfficherAgentActif = new JCheckBox(
      "Display activated agent", true);
  public JCheckBox cTjsCentrerSurAgentActif = new JCheckBox(
      "Always center on activated agent", false);
  ...
  public void add(JPanel rightPanel) {
    ...
    this.pMoteurAgent
        .setBorder(BorderFactory.createTitledBorder("Moteur agent"));
    ...
    this.bCreateAgentAgents.setToolTipText(
        "Create AGENT agents associated to the objects of the whole dataset");
    ...
    this.bCreateGaelAgents.setToolTipText(
        "Create GAEL agents associated to the objects of the whole dataset");
    this.pMoteurAgent.add(this.bCreateGaelAgents, c);

    this.bCreateCartacomAgents.addActionListener(new ActionListener() {
      @Override
      public void actionPerformed(ActionEvent arg0) {
        AgentUtil.createCartacomAgentsInDataset(
            CartAGenDoc.getInstance().getCurrentDataset());
      }
    });
    this.bCreateCartacomAgents.setFont(font);
    this.bCreateCartacomAgents.setToolTipText(
        "Create CartACom agents associated to the objects of the whole dataset");
    this.pMoteurAgent.add(this.bCreateCartacomAgents, c);

    c.insets = new Insets(1, 5, 15, 5);
    this.bCreateAgents.setFont(font);
    this.bCreateAgents.setToolTipText(
        "Create agents associated to the objects of the whole dataset");
    ...
    this.bInfoSelection.setToolTipText(
        "Informations on the generalisation tree of the selected agents");
    ...
    this.bChargerSelection.addActionListener(new ActionListener() {
      ...
      public void actionPerformed(ActionEvent arg0) {
        ...
        if (features == null || features.isEmpty()) {
          features = null;
          features = CartAGenPlugin.getInstance().getApplication()
        ...
        for (IFeature obj : features) {
          ...
          GeneralisationRightPanelAgentComplement.getLogger()
              .info("Chargement de " + ago);
          AgentGeneralisationScheduler.getInstance().add(ago);
        }
      }
    });
    this.bChargerSelection.setFont(font);
    this.bChargerSelection.setToolTipText(
        "Charge les agents selectionnés dans la liste du moteur");
    ...
    this.bRemove.addActionListener(new ActionListener() {
      @Override
      public void actionPerformed(ActionEvent arg0) {
        for (Object o : GeneralisationRightPanelAgentComplement.this.jList
            .getSelectedValues()) {
    ...
    this.bRemove
        .setToolTipText("Remove the selected agents from the scheduler list");
    ...
    this.bDemarrerArreterMoteur.setIcon(
        new ImageIcon(GeneralisationRightPanelAgentComplement.class
    ...
    this.cAfficherAgentActif
        .setToolTipText("Affiche l'agent en cours d'activation");
        ...
        if (Agent.getActivatedAgent() != null) {
          try {
            CartAGenPlugin.getInstance().getApplication().getMainFrame()
                ...
                .center(((GeographicObjectAgent) Agent.getActivatedAgent())
                    .getFeature());
    ...
    this.bcentrerSurAgentActif
        .setToolTipText("Centrer la vue sur l'agent en cours d'activation");
    this.bcentrerSurAgentActif.setFont(font);
    this.pMoteurAgent.add(this.bcentrerSurAgentActif, c);

    this.cTjsCentrerSurAgentActif.setToolTipText(
        "Toujours centrer automatiquement la vue sur l'agent en cours d'activation");
    ...
    this.cStockerEtats.addChangeListener(new ChangeListener() {
      ...
      public void stateChanged(ChangeEvent e) {
        AgentSpecifications.getLifeCycle().setStoreStates(
            GeneralisationRightPanelAgentComplement.this.cStockerEtats
                .isSelected());
      }
    });
    ...
    this.bRestoreAll.addActionListener(new ActionListener() {
      ...
      public void actionPerformed(ActionEvent arg0) {
        ...
        // Urban alignments
        for (IUrbanAlignment obj : CartAGenDoc.getInstance().getCurrentDataset()
            .getUrbanAlignments()) {
    ...
    this.bRestoreAll
        .setToolTipText("Restore intial state of all agents of the dataset");
     ...
     * ((NumberAxis
     * )((XYPlot)chart.getPlot()).getDomainAxis()).setStandardTickUnits
  ...
  public void majAgentsListe() {
    ...
    this.lNbAgentsListe
        .setText(Integer.toString(this.jList.getModel().getSize()));
  }
