 ...
 * @copyright IGN
 ******************************************************************************/
package fr.ign.cogit.cartagen.appli.utilities.renderer;
...
import fr.ign.cogit.cartagen.appli.utilities.RangeSlider;
...
public class RangeSliderUI extends BasicSliderUI {
    ...
    protected void calculateThumbLocation() {
        ...
        if (this.slider.getOrientation() == SwingConstants.HORIZONTAL) {
            int upperPosition = this.xPositionForValue(this.slider.getValue() + this.slider.getExtent());
            this.upperThumbRect.x = upperPosition - (this.upperThumbRect.width / 2);
            this.upperThumbRect.y = this.trackRect.y;

        } else {
            int upperPosition = this.yPositionForValue(this.slider.getValue() + this.slider.getExtent());
    ...
    private void setUpperThumbLocation(int x, int y) {
        ...
        SwingUtilities.computeUnion(this.upperThumbRect.x, this.upperThumbRect.y, this.upperThumbRect.width,
                this.upperThumbRect.height, upperUnionRect);
    ...
    public void scrollByUnit(int direction) {
        synchronized (this.slider) {
            int delta = 1 * ((direction > 0) ? BasicSliderUI.POSITIVE_SCROLL : BasicSliderUI.NEGATIVE_SCROLL);
    ...
    public class RangeTrackListener extends TrackListener {
        ...
        private void moveLowerThumb() {
            ...
            case SwingConstants.VERTICAL:
                ...
                int vMax = RangeSliderUI.this.yPositionForValue(
                        RangeSliderUI.this.slider.getValue() + RangeSliderUI.this.slider.getExtent());
            ...
            case SwingConstants.HORIZONTAL:
                ...
                int hMax = RangeSliderUI.this.xPositionForValue(
                        RangeSliderUI.this.slider.getValue() + RangeSliderUI.this.slider.getExtent());
        ...
        private void moveUpperThumb() {
            ...
            case SwingConstants.VERTICAL:
                ...
                thumbMiddle = thumbTop + halfThumbHeight;
                RangeSliderUI.this.slider.setExtent(
                        RangeSliderUI.this.valueForYPosition(thumbMiddle) - RangeSliderUI.this.slider.getValue());
                break;
            ...
            case SwingConstants.HORIZONTAL:
                ...
                thumbMiddle = thumbLeft + halfThumbWidth;
                RangeSliderUI.this.slider.setExtent(
                        RangeSliderUI.this.valueForXPosition(thumbMiddle) - RangeSliderUI.this.slider.getValue());
                break;
