...
public class ImportDataFrame2 extends JFrame implements ActionListener {
     ...
     */
    public static ImportDataFrame2 getInstance(boolean isInitial, CartAGenPlugin plugIn) {
    ...
    private final JTextField txtZone, txtDataset, txtScale, txtPath, txtExtent, txtXML;
    ...
    public ImportDataFrame2(CartAGenPlugin plugIn) {
        ...
        zonePanel.setBorder(BorderFactory.createTitledBorder(blackLine, "Description of the zone"));
        ...
        try {
            this.txtScale.getDocument().insertString(0, "25000", new SimpleAttributeSet());
        ...
        ImageIcon icon = new ImageIcon(
                ImportDataFrame2.class.getResource("/images/browse.jpeg").getPath().replaceAll("%20", " "));
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getActionCommand().equals("Cancel")) {
            ...
            this.importDataSet((SourceDLM) this.cbSourceDlm.getSelectedItem(),
                    Integer.parseInt(this.txtScale.getText()), this.txtZone.getText(), this.txtDataset.getText(),
                    this.txtPath.getText(), this.txtExtent.getText(), this.rbFile.isSelected(),
                    this.cbType.getSelectedItem().equals("DLM"), true, mapping);

            try {
                plugIn.getProjectFrameFromDbName(this.txtDataset.getText()).getLayerViewPanel().getViewport()
                        .zoomToFullExtent();
    ...
    public void importDataSet(SourceDLM source, int scale, String txtZone, String txtDataset, String filePath,
            String txtExtent, boolean rbFileSelected, boolean dlmSelected, boolean withEnrichment,
        ...
        new CartAGenLoader().loadData(this.filePath, this.sourceDlm, scale, dataset, shapefileMapping);
