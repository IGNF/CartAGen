...
public class OsmGeneObj extends GeneObjDefault implements OSMFeature {
    ...
    public Object getAttribute(String nomAttribut) {
        ...
        if (((AttributeType) attribute).getNomField().length() == 0) {
            ...
            nomFieldMaj = Character.toUpperCase(
                    ((AttributeType) attribute).getNomField().charAt(0))
        ...
        for (Field field : classObj.getDeclaredFields()) {
            ...
            try {
                ...
                String setterName = "set"
                        + field.getName().substring(0, 1).toUpperCase()
                        + field.getName().substring(1);
                Method setter = classObj.getDeclaredMethod(setterName,
                        field.getType());
     ...
     **/
    @Override
    public int compareTo(OSMFeature arg0) {
