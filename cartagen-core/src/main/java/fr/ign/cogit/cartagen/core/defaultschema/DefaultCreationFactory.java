...
import fr.ign.cogit.cartagen.core.defaultschema.partition.PartitionElement;
...
public class DefaultCreationFactory extends AbstractCreationFactory {
	...
	public IUrbanAlignment createUrbanAlignment(List<IUrbanElement> urbanElements, ILineString shapeLine,
		...
		return new UrbanAlignment(urbanElements, shapeLine, initialElement, finalElement);
	}
	...
	public IReliefField createReliefField(Collection<IContourLine> contourLines) {
		return new ReliefField(contourLines);
	}
	...
	public IMiscPoint createMiscPoint(IPoint point) {
		DefaultCreationFactory.logger.error("Non implemented creation factory method for IMiscPoint");
		return null;
	}
	...
	public IPartitionElement createPartitionElement(IPolygon poly) {
		IPartitionElement element = new PartitionElement();
		element.setGeom(poly);
		return element;
	}
