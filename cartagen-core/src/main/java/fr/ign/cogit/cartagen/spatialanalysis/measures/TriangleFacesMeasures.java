...
public class TriangleFacesMeasures {
  ...
  public static double getX(ITriangleFace tri) {
    return (tri.getNode1().getPosition().getX()
        ...
        + tri.getNode3().getPosition().getX()) / 3.0;
  }
  ...
  public static double getY(ITriangleFace tri) {
    return (tri.getNode1().getPosition().getY()
        ...
        + tri.getNode3().getPosition().getY()) / 3.0;
  }
   ...
   *         false otherwise
   */
  public static boolean containsInitial(ITriangleFace tri,
      IDirectPosition pos) {
  ...
  public static double getArea(ITriangleFace tri) {
    ...
    return s * Math.abs(tri.getNode2().getPosition().getX()
  ...
  public static String getDirection(ITriangleFace tri) {
    double pv = (tri.getNode2().getPosition().getX()
        - tri.getNode1().getPosition().getX())
        * (tri.getNode3().getPosition().getY()
            - tri.getNode1().getPosition().getY())
        - (tri.getNode2().getPosition().getY()
  ...
  public static double getZ(ITriangleFace tri, IDirectPosition pos) {
    double ux = (tri.getNode2().getPosition().getY()
        - tri.getNode1().getPosition().getY())
        * (tri.getNode3().getPosition().getZ()
            - tri.getNode1().getPosition().getZ())
        - (tri.getNode2().getPosition().getZ()
            - tri.getNode1().getPosition().getZ())
            * (tri.getNode3().getPosition().getY()
                - tri.getNode1().getPosition().getY());
    double uy = (tri.getNode2().getPosition().getZ()
        - tri.getNode1().getPosition().getZ())
        * (tri.getNode3().getPosition().getX()
            - tri.getNode1().getPosition().getX())
        - (tri.getNode2().getPosition().getX()
            ...
            * (tri.getNode3().getPosition().getZ()
                - tri.getNode1().getPosition().getZ());
    double uz = (tri.getNode2().getPosition().getX()
        - tri.getNode1().getPosition().getX())
        * (tri.getNode3().getPosition().getY()
            - tri.getNode1().getPosition().getY())
        - (tri.getNode2().getPosition().getY()
    ...
    return tri.getNode1().getPosition().getZ()
        + (ux * (tri.getNode1().getPosition().getX() - pos.getX())
            + uy * (tri.getNode1().getPosition().getY() - pos.getY())) / uz;
  }
  ...
  public static double getSlopeAngle(ITriangleFace tri) {
    double dx = (tri.getNode2().getPosition().getY()
        - tri.getNode1().getPosition().getY())
        * (tri.getNode3().getPosition().getZ()
            - tri.getNode1().getPosition().getZ())
        - (tri.getNode2().getPosition().getZ()
            ...
            * (tri.getNode3().getPosition().getY()
                - tri.getNode1().getPosition().getY());
    double dy = (tri.getNode2().getPosition().getZ()
        - tri.getNode1().getPosition().getZ())
        * (tri.getNode3().getPosition().getX()
            - tri.getNode1().getPosition().getX())
        - (tri.getNode2().getPosition().getX()
            ...
            * (tri.getNode3().getPosition().getZ()
                - tri.getNode1().getPosition().getZ());
    double dz = (tri.getNode2().getPosition().getX()
        - tri.getNode1().getPosition().getX())
        * (tri.getNode3().getPosition().getY()
            - tri.getNode1().getPosition().getY())
        - (tri.getNode2().getPosition().getY()
  ...
  public static double[] getSlopeVector(ITriangleFace tri) {
    ...
    slopeVector[0] = (tri.getNode2().getPosition().getY()
        - tri.getNode1().getPosition().getY())
        * (tri.getNode3().getPosition().getZ()
            - tri.getNode1().getPosition().getZ())
        - (tri.getNode2().getPosition().getZ()
            ...
            * (tri.getNode3().getPosition().getY()
                - tri.getNode1().getPosition().getY());
    slopeVector[1] = (tri.getNode2().getPosition().getZ()
        - tri.getNode1().getPosition().getZ())
        * (tri.getNode3().getPosition().getX()
            - tri.getNode1().getPosition().getX())
        - (tri.getNode2().getPosition().getX()
            ...
            * (tri.getNode3().getPosition().getZ()
                - tri.getNode1().getPosition().getZ());
    slopeVector[2] = (tri.getNode2().getPosition().getX()
        - tri.getNode1().getPosition().getX())
        * (tri.getNode3().getPosition().getY()
            - tri.getNode1().getPosition().getY())
        - (tri.getNode2().getPosition().getY()
    ...
    // compute the norm
    double norm = Math.sqrt(slopeVector[0] * slopeVector[0]
        + slopeVector[1] * slopeVector[1] + slopeVector[2] * slopeVector[2]);
  ...
  public static double getInitialSlopeAzimutalOrientation(ITriangleFace tri) {
    double dx = (tri.getNode2().getPositionIni().getY()
        - tri.getNode1().getPositionIni().getY())
        * (tri.getNode3().getPositionIni().getZ()
            - tri.getNode1().getPositionIni().getZ())
        - (tri.getNode2().getPositionIni().getZ()
            - tri.getNode1().getPositionIni().getZ())
            * (tri.getNode3().getPositionIni().getY()
                - tri.getNode1().getPositionIni().getY());
    double dy = (tri.getNode2().getPositionIni().getZ()
        - tri.getNode1().getPositionIni().getZ())
        * (tri.getNode3().getPositionIni().getX()
            - tri.getNode1().getPositionIni().getX())
        - (tri.getNode2().getPositionIni().getX()
   ...
   */
  public static double getSlopeAzimutalOrientationDifference(
      ITriangleFace tri) {
