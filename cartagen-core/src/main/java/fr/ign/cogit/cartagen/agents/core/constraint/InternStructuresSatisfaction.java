 ...
 * 
 */
public class InternStructuresSatisfaction<ComponentClass extends GeographicObjectAgent>
    extends GeographicObjectConstraintImpl {

  /**
   * value of the measure: the satisfaction of the components
   */
  private double internStructuresSatisfaction;

  /**
   * @param agent
   * @param importance
   */
  public InternStructuresSatisfaction(GeographicObjectAgent agent,
      double importance) {
  ...
  public void computeCurrentValue() {
    this.internStructuresSatisfaction = ((MesoAgent<?>) this.getAgent())
        .getInternStructuresSatisfaction();
  }
  ...
  public void computeSatisfaction() {
    ...
    this.setSatisfaction(this.internStructuresSatisfaction);
  }
  ...
  public Set<ActionProposal> getActions() {
    ...
    Action actionToPropose = new MesoComponentsActivation<ComponentClass>(
