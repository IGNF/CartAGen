...
public class RoadNetworkMenuCogitComplement extends JMenu {
    ...
    private Logger logger = Logger.getLogger(RoadNetworkMenuCogitComplement.class.getName());

    // private JLabel lblCogit = new JLabel(" COGIT");

    private JMenuItem mRoutierDetectMotorways = new JMenuItem(new DualCarriageAction());
    private JMenuItem mRoutierCollapseMotorways = new JMenuItem(new CollapseDualCarriageAction());
    ...
    private class DualCarriageAction extends AbstractAction {
        ...
        public DualCarriageAction() {
            this.putValue(Action.SHORT_DESCRIPTION, "Detect dual carriageways in the road network (stage de P. Danré)");
    ...
    private class CollapseDualCarriageAction extends AbstractAction {
        ...
        public CollapseDualCarriageAction() {
            this.putValue(Action.SHORT_DESCRIPTION, "Collapse dual carriageways into centreline (stage de P. Danré)");
